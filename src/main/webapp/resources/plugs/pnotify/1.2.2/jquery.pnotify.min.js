...
(function (d) {
    ...
    d.extend({
        pnotify_remove_all: function () {
            ...
            var b = d("<div />", {
                "class": "ui-pnotify " + a.addclass, css: {display: "none"}, mouseenter: function (p) {
            ...
            b.opts = a;
            b.container = d("<div />", {
                "class": f.container + " ui-pnotify-container " + ("error" == a.type ? f.error : "info" == a.type ? f.info : "success" ==
            ...
            b.pnotify = function (p) {
                ...
                if (a.icon !== c.icon || !0 === a.icon && a.type != c.type)b.container.find("div.ui-pnotify-icon").remove(), !1 !== a.icon && d("<div />", {"class": "ui-pnotify-icon"}).append(d("<span />", {
                    "class": !0 ===
            ...
            b.sticker =
                d("<div />", {
                    ...
                    css: {cursor: "pointer", visibility: a.sticker_hover ? "hidden" : "visible"},
                    click: function () {
                        a.hide = !a.hide;
            ...
            if (a.history) {
                ...
                "undefined" == typeof q && (q = d("<div />", {
                    ...
                    text: a.labels.redisplay
                })).append(d("<button />", {
                    "class": "ui-pnotify-history-all " + f.hi_btn, text: a.labels.all, mouseenter: function () {
                    ...
                    "class": "ui-pnotify-history-last " + f.hi_btn, text: a.labels.last, mouseenter: function () {
                        d(this).addClass(f.hi_btnhov)
                    }, mouseleave: function () {
                        d(this).removeClass(f.hi_btnhov)
                    }, click: function () {
    ...
    d.pnotify.defaults = {
        ...
        labels: {redisplay: "Redisplay", all: "All", last: "Last", close: "Close", stick: "Stick"}
    }
})(jQuery);
